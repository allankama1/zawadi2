...
from Hosiapp.credentials import MpesaAccessToken, LipanaMpesaPpassword
...
def token(request):
    consumer_key = 'r2eAkKAGE2bdrXj55WGtKgGNaZJh284vlMsNhkN5jXjGXsNA'
    consumer_secret = 'G6Vqu6Mqoi5fgl7BQ6JEjLtgeLxG3qws4xxhs40lhCwiWAxRHqgMkn50xGKdggYc'
